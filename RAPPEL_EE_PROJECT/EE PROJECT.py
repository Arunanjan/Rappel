#ENGINEERING EXPLORATION PROJECT BATCH 5 TKINTER APPLICATION_ RAPPEL(LIBRARY BOOK REMINDER)_____Frontend
...
def MainPage():
    ...
    def about_command():       #New window to display information about the developers
        ...
        labe=Label(window_8,bg="SteelBlue1",font=("Elephant",11),text="Developers of RAPPEL ver_1.0\n\nG.R.Rohith(160120733107,CSE-2)\nArunanjan Bandari(160120733093,CSE-2)\nArshia Parveen(160120733065,CSE-2)\nJayesh Dhoot(160120733101,CSE-2)\nSatya Susheela(160120733079,CSE-2)\n\nSpecial thanks to:\nKalpana Agarwal(CSE Department)\nKarthik(CSE Department)")
        labe.pack()
        window_8.mainloop()
